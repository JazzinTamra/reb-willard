...
<main>
		...
		<div class="row">
			...
			<article>
					<div class="container-fluid ">
						<img class="img-responsive pull-left container-fluid col-lg-10 col-md-8 col-sm-9
						 col-xs-12" src="<?php echo $PREFIX?>img/cowspecs.jpg" alt="Cowspecs">
						<div class="" >
									<p><b>Reb Willard</b> is influenced by the natural world; she re-imagines the landscape that surrounds her and pours intense color and unusual textures onto canvas to create the color-saturated world she envisions.
			Her artistic toolbox includes all manner of media: acrylics, pastels, oils, pencil, charcoal, water color, and photography.  </p>
			<p>
			Currently Reb is as a professional artist working in her hometown, Provo, Utah. She is blessed to be able to create art full-time. It’s a gift to be able to let one’s imagination roam the corners of the mind and dig out the stories buried there.
...
<!--			<img class="small align-center" src="--><?php //echo $PREFIX?><!--img/cps-oma.jpg" alt="Reb by her Granddaughter">-->
						...
						<p>
						Reb turned her talent into a career, and has created art most of her life
