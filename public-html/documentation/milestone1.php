...
<html lang="en">
	<head>
		<meta charset="utf-8"/>
		<title>Milestone 1: Website for the artist Reb Willard</title>
	</head>
	<body>
		<main>
			...
			<ul>
				<li>To serve as a gallery to showcase and promote Reb's work.</li>
				<li>To increase sales of paintings and photographs by Reb Willard.</li>
				<li>To increase the reach and establish more of a social media presence for Reb Willard's work (as measured
					via analytics tools).
				</li>
				<li>To help me showcase my web development skills leading to a full-time great paying job.</li>
			</ul>
		</main>
	</body>
